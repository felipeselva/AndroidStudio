...
import { Picker } from '@react-native-picker/picker'; // Biblioteca instalada

export default function CoursesScreen() {
  const [selectedCategory, setSelectedCategory] = useState('Todas');

  // Dados fictícios dos cursos (ODS 4)
  const courses = [
  ...
  // Filtro da lista com base no Picker
  ...
  return (
    <View style={styles.container}>
      ...
      {/* --- REQUISITO: Componente Picker (Obrigatório na Tabela) --- */}
